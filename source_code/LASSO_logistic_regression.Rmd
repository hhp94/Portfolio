...
# Results
## Classical Logistic Regression with Newton-Raphson optimizer
...
Newton-Raphson logistic function and `{glmnet}` to make sure that 
soft-thresholding with $\lambda = 0$ yields the same results.
